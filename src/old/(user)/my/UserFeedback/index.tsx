import { UserFeedbackHeadIcon, UserFeedbackStarIcon } from '@/app/(user)/my/icon';

import { HeroSection, PageWrapper, Section, UserFeedbackCard } from './style';
            ...
            <Section className="mt-16">
                <div className="flex gap-4 justify-center w-full">
                    <HeroSection>
                        ...
                        <div className="text-2xl text-gray-600 mb-16">看看家长和老师们怎么说</div>
                    </HeroSection>
                </div>
