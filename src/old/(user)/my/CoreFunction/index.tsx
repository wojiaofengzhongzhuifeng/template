...
import { FeatureCard, HeroSection, PageWrapper, Section } from './style';
                    ...
                    <HeroSection>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                            ...
                            <FeatureCard bgClass="bg-orange-50" borderClass="border-orange-200">
                                <IntelligentIcon />
                                <div className="text-2xl text-orange-600 flex mb-5">AI智能生成</div>
                            ...
                            <FeatureCard bgClass="bg-pink-50" borderClass="border-pink-200">
                                <ArtisticIcon />
                                <div className="text-2xl text-pink-600 flex mb-5">多样插画风格</div>
                                <div className="text-sm text-gray-600 flex-item text-start">
                            ...
                            <FeatureCard bgClass="bg-purple-50" borderClass="border-purple-200">
                                <ProfessionalIcon />
                                <div className="text-2xl text-purple-600 flex mb-5">专业编辑器</div>
                                <div className="text-sm text-gray-600 flex-item text-start">
