...
import type { IBlogMetadata } from '@/app-old/_components/blog/metadata';
import type { IPaginateQueryProps } from '@/app-old/_components/paginate/types';

import { BlogIndex } from '@/app-old/_components/blog/list';
import { getBlogMetadata } from '@/app-old/_components/blog/metadata';
